...
AgregarVariables  <- function( dataset )
{
  ...
  dataset[ , mprestamos_total       := mprestamos_personales+mprestamos_prendarios+mprestamos_hipotecarios ]
  dataset[ , mconsumotarjetas_total := mtarjeta_visa_consumo+mtarjeta_master_consumo ]
