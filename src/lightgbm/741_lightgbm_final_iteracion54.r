...
kmax_bin           <-    31
klearning_rate     <-     0.0100479065581452
knum_iterations    <-   1203
knum_leaves        <-  1953
kmin_data_in_leaf  <- 17153
kfeature_fraction  <-     0.222015657374995
...
dir.create( "./exp/sinCambiarNada/itera54/",  showWarnings = FALSE ) 
dir.create( paste0("./exp/sinCambiarNada/itera54/", kexperimento, "/" ), showWarnings = FALSE )
setwd( paste0("./exp/sinCambiarNada/itera54/", kexperimento, "/" ) )   #Establezco el Working Directory DEL EXPERIMENTO
