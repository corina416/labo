...
kmax_bin           <-    31
klearning_rate     <-     0.0100774482269318
knum_iterations    <-   1410
knum_leaves        <-  2027
kmin_data_in_leaf  <- 11607
kfeature_fraction  <-     0.244065428361415
...
dir.create( "./exp/sinCambiarNada/itera52/",  showWarnings = FALSE ) 
dir.create( paste0("./exp/sinCambiarNada/itera52/", kexperimento, "/" ), showWarnings = FALSE )
setwd( paste0("./exp/sinCambiarNada/itera52/", kexperimento, "/" ) )   #Establezco el Working Directory DEL EXPERIMENTO
