...
kmax_bin           <-    31
klearning_rate     <-     0.0120724136292691
knum_iterations    <-   1314
knum_leaves        <-  613
kmin_data_in_leaf  <- 20050
kfeature_fraction  <-     0.491462778916905
...
dir.create( "./exp/camHiperparam/",  showWarnings = FALSE ) 
dir.create( paste0("./exp/camHiperparam/", kexperimento, "/" ), showWarnings = FALSE )
setwd( paste0("./exp/camHiperparam/", kexperimento, "/" ) )   #Establezco el Working Directory DEL EXPERIMENTO
