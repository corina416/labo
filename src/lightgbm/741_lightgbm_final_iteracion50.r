...
kmax_bin           <-    31
klearning_rate     <-     0.0100109355833415
knum_iterations    <-   712
knum_leaves        <-  2046
kmin_data_in_leaf  <- 10695
kfeature_fraction  <-     0.633872237202276
...
dir.create( "./exp/sinCambiarNada/itera50/",  showWarnings = FALSE ) 
dir.create( paste0("./exp/sinCambiarNada/itera50/", kexperimento, "/" ), showWarnings = FALSE )
setwd( paste0("./exp/sinCambiarNada/itera50/", kexperimento, "/" ) )   #Establezco el Working Directory DEL EXPERIMENTO
